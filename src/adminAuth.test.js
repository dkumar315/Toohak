...
describe('adminAuthLogin', () => {
  describe('valid input', () => {
    ...
    test('Test for mutiple users', () => {
      adminAuthRegister("test@example.com", "passw0rd", "Jane", "Smith");
      adminAuthRegister("testss@example.com", "passw0rd", "Jane", "Smith");
      adminAuthRegister("tests@example.com", "passw0rd", "Jane", "Smith");
      
      const result1 = adminAuthLogin("test@example.com", "passw0rd");
      expect(result1).toStrictEqual({ authUserId: expect.any(Number) });

      const result2 = adminAuthLogin("testss@example.com", "passw0rd");
      expect(result2).toStrictEqual({ authUserId: expect.any(Number) });

      const result3 = adminAuthLogin("tests@example.com", "passw0rd");
      expect(result3).toStrictEqual({ authUserId: expect.any(Number) });
    });
  });
  ...
  describe('Test with userDetail', () => {
    test('Test if userDetail is successfully set', () => {
      ...
      expect(userDetail.numSuccessfulLogins).toStrictEqual(0);
